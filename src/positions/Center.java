package positions;
/*
 * * For players in center position */
public class Center extends Player {
    private static final double PTS_WEIGHT = 0.2;
    private static final double TRB_WEIGHT = 0.3;
    private static final double AST_WEIGHT = 0.1;
    private static final double BLK_WEIGHT = 0.25;
    private static final double STL_WEIGHT = 0.15;
